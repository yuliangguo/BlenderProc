...
do
  python run.py examples/bop_scene_replication/config_normal_only.yaml /media/hmiintern/8bd15be5-5b44-45d1-83ed-45049c3ccdbc/datasets/cosypose/local_data/bop_datasets tless /home/hmiintern/projects/bop_toolkit_cosypose /media/hmiintern/8bd15be5-5b44-45d1-83ed-45049c3ccdbc/datasets/blenderproc/bop_scene_replication train primesense $scene_id
done
